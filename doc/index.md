...
-->
ここまでで、システム上で LXD が実行されているでしょうから、[はじめに](https://linuxcontainers.org/lxd/getting-started-cli/) という文書を読んだり、[ドキュメント](https://lxd.readthedocs.org) （[ドキュメント（日本語訳）](https://lxd-ja.readthedocs.io/ja/latest/)）の例や設定を見たりできます。
