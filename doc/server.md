...
network.ovn.northbound\_connection  | string    | global    | unix:/var/run/ovn/ovnnb_db.sock | network\_type\_ovn                | OVN northbound データベース接続文字列 <!-- OVN northbound database connection string -->
